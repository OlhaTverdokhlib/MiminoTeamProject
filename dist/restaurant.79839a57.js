!function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.NiceSelect = t() : e.NiceSelect = t();
        ...
        return u.prototype.create = function() {
        ...
        }, u.prototype.processData = function(e2) {
            var t = [];
            e2.forEach((e)=>{
                t.push({
                    data: e,
            ...
            this.resetSelectValue(), this.selectedOptions = [], this._renderSelectedItems(), this.update(), s1(this.el);
        ...
        }, u.prototype._onClicked = function(e5) {
            var t, i;
            if (e5.preventDefault(), a(this.dropdown, "open") ? this.multiple || (h(this.dropdown, "open"), d(this.el)) : (c(this.dropdown, "open"), t = this.el, (i = document.createEvent("UIEvent")).initEvent("modalopen", !0, !1), t.dispatchEvent(i)), a(this.dropdown, "open")) {
        ...
        }, u.prototype._onItemClicked = function(e6, t) {
            var i = t.target;
            a(i, "disabled") || (this.multiple ? a(i, "selected") ? (h(i, "selected"), this.selectedOptions.splice(this.selectedOptions.indexOf(e6), 1), this.el.querySelector(`option[value="${i.dataset.value}"]`).removeAttribute("selected")) : (c(i, "selected"), this.selectedOptions.push(e6)) : (this.selectedOptions.forEach(function(e) {
            ...
            if (13 == e.keyCode) i1(s ? t : this.dropdown);
                ...
                e.preventDefault();
            } else if (27 == e.keyCode && s) i1(this.dropdown);
            ...
            return null;
        }, u.prototype._onSearchChanged = function(e7) {
            var t3 = a(this.dropdown, "open"), i2 = e7.target.value;
...
//# sourceMappingURL=restaurant.79839a57.js.map
